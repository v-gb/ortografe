...
module Lexique = struct
  ...
  let[@ocamlformat "disable"] not_usable_words () =
    Hash_set.of_list (module String) [
        ...
        "species"; "crossman"; "rezzou"; "weekend"; "weekends"; "blackout"; "stripteases";
        "croquemonsieur"; "sidecar"; "sidecars"; "covergirl"; "stripteaseur";
        "stripteaseurs"; "lockout"; "bluejeans"; "bluejean"; "covergirl"; "covergirls";
        "édelweiss"; "pizzéria"; "pizzérias"; "leitmotivs"; "sosténuto";
